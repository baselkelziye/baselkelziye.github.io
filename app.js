...
// when 4,3 and 3,3 add one to right (2,3) and make tail
//wehn 5,1 and  6,1 add one to left (4,1) and make tail
// when 7,3 and  7,4 add one above (7,2) and make tail
//when 1,6 and 1,5 add one to bellow (1,7) and make tail
